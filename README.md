...
**Note:** Make sure to add JitPack repository in `settings.gradle`:
...
### 6. JitPack Dependency Issues (401 Unauthorized)
...
If v2.0.24 hasn't been built yet, try using a previously built version.
