...
[![Release Version](https://img.shields.io/badge/release-2.0.8-blue.svg)](https://gitee.com/maxchou/walle/releases)
...
```gradle
dependencies {
    implementation 'com.gitee.maxchou:walle:2.0.8'
}
```
...
buildscript {
    ...
    dependencies {
        classpath 'com.gitee.maxchou:walle-plugin:2.0.8'
    }
}
```
...
| 模块 | Maven 坐标 | 说明 |
|------|-----------|------|
| **library** | `com.gitee.maxchou:walle:2.0.8` | Android Library，提供渠道信息读取功能 |
| **plugin** | `com.gitee.maxchou:walle-plugin:2.0.8` | Gradle 插件（已适配 AGP 8.x）|
| **payload_reader** | `com.gitee.maxchou:payload_reader:2.0.8` | APK Signing Block 读取模块 |
| **payload_writer** | `com.gitee.maxchou:payload_writer:2.0.8` | APK Signing Block 写入模块 |
| **walle-cli** | - | 命令行工具 |
| app | - | 示例应用 |
...
```gradle
dependencies {
    implementation 'com.gitee.maxchou:payload_reader:2.0.8'
}
```
...
```gradle
dependencies {
    implementation 'com.gitee.maxchou:payload_writer:2.0.8'
}
```
